<?php
/**
 * Automated Database Installer for Online Examination System
 * 
...
// Start installation
printHeader("Online Examination System - Database Installer");
...
if (!file_exists($envFile)) {
    ...
    if (file_exists($envExample)) {
        ...
        printWarning("Please edit .env file with your database credentials before continuing.");
        printInfo("Then run this installer again: php database/install.php");
        exit(0);
    } else {
...
if (!defined('DB_HOST') || !defined('DB_NAME') || !defined('DB_USER') || !defined('DB_PASS')) {
    ...
    printInfo("Please ensure DB_HOST, DB_NAME, DB_USER, and DB_PASS are defined in config/database.php");
    exit(1);
}
...
// Step 2: Connect to MySQL (without database)
...
try {
    ...
    printInfo("\nPlease check:");
    printInfo("1. MySQL server is running");
    printInfo("2. Database credentials in .env are correct");
    printInfo("3. User has sufficient privileges");
    exit(1);
}
...
try {
    ...
    printInfo("Created $tableCount tables");
